...
class Ui_StatisticsWindow(object):
    def setupUi(self, StatisticsWindow):
        ...
        StatisticsWindow.resize(896, 725)
        ...
        self.player_value_graph = QtWidgets.QGraphicsView(self.centralwidget)
        self.player_value_graph.setObjectName("player_value_graph")
        self.gridLayout.addWidget(self.player_value_graph, 3, 5, 4, 6)
        ...
        self.gridLayout.addWidget(self.player_table, 2, 0, 1, 11)
        self.player_points_graph = QtWidgets.QGraphicsView(self.centralwidget)
        self.player_points_graph.setObjectName("player_points_graph")
        self.gridLayout.addWidget(self.player_points_graph, 3, 2, 4, 3)
