...
class Ui_StatisticsWindow(object):
    def setupUi(self, StatisticsWindow):
        ...
        self.gridLayout.addWidget(self.total_assets_display, 1, 5, 1, 1)
        ...
        self.gridLayout.addWidget(self.team_value_display, 1, 4, 1, 1)
        ...
        self.gridLayout.addWidget(self.balance_display, 1, 6, 1, 1)
