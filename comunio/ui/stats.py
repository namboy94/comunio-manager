...
class Ui_StatisticsWindow(object):
    def setupUi(self, StatisticsWindow):
        ...
        StatisticsWindow.resize(896, 536)
        ...
        self.gridLayout.addWidget(self.value_graph, 3, 4, 5, 8)
    ...
    def retranslateUi(self, StatisticsWindow):
        ...
        self.points_graph.setText(_translate("StatisticsWindow", "Points"))
        self.value_graph.setText(_translate("StatisticsWindow", "Values"))
